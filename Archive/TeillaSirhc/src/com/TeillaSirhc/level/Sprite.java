...
public class Sprite {
	...
	public void update() {
		...
		int screenCoords[] = getScreenCoords( width, height, -1.0f);
	...
	/*
	public int glhProjectf(float objx, float objy, float objz)
	  {
		 FloatBuffer modelview;
		 FloatBuffer projection;
		 IntBuffer viewport;
		 VertexArray windowCoordinate
	  ...
	  function SWAP_ROWS_DOUBLE(a, b) { double *_tmp = a; (a)=(b); (b)=_tmp; }
	  function SWAP_ROWS_FLOAT(a, b) { float *_tmp = a; (a)=(b); (b)=_tmp; }
	...
	*/
	...
	public static int[] getScreenCoords(double x, double y, double z) {
	    ...
	    boolean result = GLU.gluUnProject((float) x, (float) y, (float) winZ, modelView, projection, viewport, screenCoords);
	    if (result) {
